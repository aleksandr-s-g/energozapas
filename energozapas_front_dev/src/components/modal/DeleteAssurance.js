...
export default class DeleteAssurance extends React.Component {
    state = {
        isOpen: false
    }
            ...
            <React.Fragment>
                ...
                {this.state.isOpen && (<div style={styles.modal}>
                    <div style={styles.modal_body}>
                        <h1>Вы уверены, что хотите удалить пользователя {this.props.employee.first_name} {this.props.employee.last_name}?</h1>
                        <button onClick={() => {
                            this.setState({ isOpen: false })
                            console.log(this.props.removePosition)
